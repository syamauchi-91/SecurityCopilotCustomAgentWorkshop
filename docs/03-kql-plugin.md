...
- サインイン失敗の理由が含まれるように、プロンプトを使ってプラグインを更新してみてください。
- 直近 24 時間のサインイン失敗を取得したあと、その後 30 分以内にサインイン成功したアカウントを特定してください。
- なぜそのアカウントがサインイン失敗しているのか、CISO 向けに分かりやすく出力するように更新してください。
